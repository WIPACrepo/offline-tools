...
class TestLibsStringmanipulation(unittest.TestCase):
    ...
    def test_replace_all_var(self):
        test_str = 'Hi {user}, this is a test string with {len:d} chars. This var {v!r:>30} will be replaced with *. This one wont: {t!a:0>4}'
        test_str_result = 'Hi *, this is a test string with * chars. This var * will be replaced with *. This one wont: *'

        self.assertEqual(stringmanipulation.replace_all_vars(test_str, '*'), test_str_result)
