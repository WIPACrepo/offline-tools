insert into datasets (dataset_id, description, season, type, enabled, working_group, comment, iceprod_id) values (@L2, "IC86 2022 Offline L2 Data Production", 2021, "L2", 1, 0, "IceProd2", @L2i ) ;
# update datasets set enabled = 0 where dataset_id = @L2x ;
select * from datasets where dataset_id = @L2x or dataset_id = @L2 ;


insert into datasets (dataset_id, description, season, type, enabled, working_group, comment, iceprod_id) values (@C3, "IC86 2022 L3 Data Production for the Cascade WG", 2021, "L3", 1, 3, "IceProd2", @C3i ) ;
...
insert into datasets (dataset_id, description, season, type, enabled, working_group, comment, iceprod_id) values (@M3, "IC86 2022 L3 Data Production for the Muon WG", 2021, "L3", 1, 1, "IceProd2", @M3i ) ;
...
insert into datasets (dataset_id, description, season, type, enabled, working_group, comment, iceprod_id) values (@L4, "IC86 2022 L4 Data Production for the Diffuse/Atmospheric Neutrinos WG", 2021, "L4", 1, 5, "IceProd2", @L4i ) ;
