...
class TestLibsFiles(unittest.TestCase):
    ...
    def test_file_checksum(self):
        ...
        self.assertEqual(files.File.get_md5(self.paths['checksum_test.dat'], self.logger), 'd41d8cd98f00b204e9800998ecf8427e')
        self.assertEqual(files.File.get_sha512(self.paths['checksum_test.dat'], self.logger), 'cf83e1357eefb8bdf1542850d66d8007d620e4050b5715dc83f4a921d36ce9ce47d0d13c5d85f2b0ff8318d2877eec2f63b931bd47417a81a538327af927da3e')
